...
-(void)layoutSubviews {
    ...
    self.profileIcon.frame = CGRectMake( 600, frame.size.height / 2 - self.profileIcon.frame.size.height / 2, self.profileIcon.frame.size.width, self.profileIcon.frame.size.height);
