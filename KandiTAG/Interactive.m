...
@interface Interactive () <UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate, UIViewControllerInteractiveTransitioning>
...
-(void)userDidPan:(UIScreenEdgePanGestureRecognizer *)recognizer {
    ...
    if (recognizer.state == UIGestureRecognizerStateBegan) {
        ...
        if (location.x < CGRectGetMidX(recognizer.view.bounds)) {
            self.presenting = YES;
            ContainerViewController *viewController = [[ContainerViewController alloc] initWithPanTarget:self];
