...
- (id)initWithFrame:(CGRect)frame style:(UITableViewStyle)style { //dont really use this, since im just using init
...
- (id)initWithCoder:(NSCoder *)decoder { //not using this either
